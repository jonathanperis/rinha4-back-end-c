...
- entrypoint/load balancer on `9999`
- two API instances
...
This repository currently keeps transport errors and classification errors at
`0` in clean CI candidate runs. Remaining ranking work is p99 reduction without
